...
// const AuthBranding = () => {
//   return (
//     <div className="relative hidden lg:flex flex-col justify-between overflow-hidden p-12 text-brand-secondary">
...
//         <a href="/" className="inline-flex items-center gap-2 text-xs font-bold bg-white/90 px-4 py-2 rounded-xl border border-white/60 shadow-xs backdrop-blur-md max-w-fit text-brand-secondary hover:text-brand-primary transition-colors">
...
//           <div className="h-1.5 w-28 rounded-full bg-brand-primary" />
...
//       <div>
//         <p className="text-xl font-black text-brand-primary tracking-tight">95%</p>
...
//     <div className="bg-white/60 border border-white/60 p-4 rounded-2xl backdrop-blur-md shadow-xs flex flex-col justify-between">
//       <div>
//         <p className="text-xl font-black text-brand-secondary tracking-tight">37.4%</p>
...
//     <div className="bg-white/60 border border-white/60 p-4 rounded-2xl backdrop-blur-md shadow-xs flex flex-col justify-between">
//       <div>
//         <p className="text-xl font-black text-brand-primary tracking-tight">&lt; 6 Jam</p>
